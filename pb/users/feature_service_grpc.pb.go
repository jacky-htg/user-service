...
func (c *featureServiceClient) List(ctx context.Context, in *MyEmpty, opts ...grpc.CallOption) (FeatureService_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &FeatureService_ServiceDesc.Streams[0], "/wiradata.users.FeatureService/List", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *packageFeatureServiceClient) List(ctx context.Context, in *MyEmpty, opts ...grpc.CallOption) (PackageFeatureService_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &PackageFeatureService_ServiceDesc.Streams[0], "/wiradata.users.PackageFeatureService/List", opts...)
	if err != nil {
		return nil, err
	}
